class MovieTicketBookingSystem:
    ...
    def book_ticket(self):
        ...
        if movie_id not in self.movies:
            ...
            return
        showtime = input(f"Enter Showtime (Available: {', '.join(self.movies[movie_id]['showtimes'])}): ")
    ...
    def update_ticket(self):
        ...
        if choice == 1:
            new_showtime = input("Enter new Showtime: ")
            if new_showtime not in self.movies[self.booked_tickets[ticket_id]['movie_id']]['showtimes']:
